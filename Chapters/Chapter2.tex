...
\begin{table}[ht]
\resizebox{\textwidth}{!}{ \begin{tabular}{p{1cm} p{2.5cm} p{13cm}}
     \hline
        \textbf{No} & \textbf{ Date} & \textbf{Title and Speaker}  \\
        \hline
       \rowcolor{lightgray} 1 & \begin{center}\
            January 24, 2019 
        \end{center} & 
      ...
      2 & \begin{center}
       ...
       \rowcolor{lightgray} 3 & \begin{center}
           July 16, 2019
